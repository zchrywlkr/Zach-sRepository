 ...
 * @author apprentice
 */
public class TicTacToe implements GameBot {
    ...
    public  String[] move(String[] board, String move, String player) {//changes number on the board to a x or o
    ...
    public int checkWinner(String[] board, String player) {//TODO chagne name checkwiner
    ...
    public int ai(String [] board, int moves){
        Random r = new Random();
        int move = 0;
